-- bean istg ur js sitting here refreshing the page, hop off my github brah 🙏
...
local wordlist = {
    ...
    ["rbxassetid://79084035550919"] = "prestidigiation",
...
local LLabel = Tab:CreateLabel("you will have to add your own words, im not doing allat")
